...
def index():
    ...
    return render_template("notepad/index.html", notepads=notepads, form=FlaskForm())
...
def create_notepad():
    ...
    if form.validate_on_submit():
        notepad_service.create(title=form.title.data, body=form.body.data, user_id=current_user.id)
...
def get_notepad(notepad_id):
    ...
    return render_template("notepad/show.html", notepad=notepad, form=FlaskForm())
...
def edit_notepad(notepad_id):
    ...
    if form.validate_on_submit():
        notepad_service.update(notepad_id, title=form.title.data, body=form.body.data)
